...
export async function resendVerificationEmail(email) {
  try {
    ...
    if (user.emailVerificationExpires && user.emailVerificationExpires > new Date(Date.now() + 15 * 60 * 1000)) {
      throw new ApiError(429, 'Verification email was sent recently. Please check your inbox or try again later.');
    }
