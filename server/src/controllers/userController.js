...
class UserController {
  ...
  static async updateProfile(req, res, next) {
    try {
      ...
      logger.error('Profile update error', { userId: req.user?.id, error: error.message });
      next(error);
    }
  }
  ...
  static async changePassword(req, res, next) {
    try {
      ...
      logger.error('Password change error', { userId: req.user?.id, error: error.message });
      next(error);
    }
  }
  ...
  static async getUserPreferences(req, res, next) {
    try {
      ...
      logger.error('Get preferences error', { userId: req.user?.id, error: error.message });
      next(error);
    }
  }
  ...
  static async updateUserPreferences(req, res, next) {
    try {
      ...
      logger.error('Update preferences error', { userId: req.user?.id, error: error.message });
      next(error);
    }
  }
}
